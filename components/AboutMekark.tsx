            ...
            "
                    ...
                    >
                        <p className="text-[15px] leading-8 text-[#676060] lg:text-[16px]">
                            Mekark is a trusted commercial construction company specializing
                            in RCC construction and civil infrastructure development. Since
                            our establishment, we have been the go-to commercial building
                            contractor for industrial clients, factory owners, builders, and
                            large enterprises across Chennai, Tamil Nadu, and India.
                        </p>

                        <p className="text-[15px] leading-8 text-[#676060] lg:text-[16px]">
                            Our expertise in reinforced cement concrete (RCC) construction,
                            combined with modern project execution methods, enables us to
                            deliver turnkey commercial building solutions that exceed
                            expectations. We are not just a construction contractor — we are
                            your structural civil contractor partner, managing everything from
                            design to final handover with precision and professionalism.
                        </p>
                    </motion.div>
